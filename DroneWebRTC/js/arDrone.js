...
var arDrone = function(ip, port){
        ...
        function startConnection(){
                return new Promise(function(resolve, reject) {
                        ...
                        var baseextra = communicator.stringToProxy("Extra:ws -h " + ip + " -p " + port);
                        ...
                        // NavData
                        var basenavdata = communicator.stringToProxy("Navdata:ws -h " + ip + " -p " + port);
                        ...
                        // CMDVelPrx
                        var basecmdVel = communicator.stringToProxy("CMDVel:ws -h " + ip + " -p " + port);
                        ...
                        // Pose3D
                       var basepose3D = communicator.stringToProxy("Pose3D:ws -h " + ip + " -p " + port);
